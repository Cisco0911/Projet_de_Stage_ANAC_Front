...
function CheckBox1({id, checked, onChange, ...props})
{
...
function CheckBox2_switch()
{
        ...
        useEffect(
                () =>
                {
                        ...
                        const activeColor = '#0000f1'

                        const switchs = document.querySelectorAll('.CheckBox2_switch')

                        switchs.forEach(toggle => {
                                ...
                                let backgroundShape = new THREE.ExtrudeGeometry(rectangle, {
                                        curveSegments: 20,
                                        depth: 2,
                                        bevelEnabled: true,
                                        bevelSegments: 20,
        ...
        return(
                <label className="CheckBox2_switch">
                        <input type="checkbox"/>
                        <canvas></canvas>
                </label>
        )
