...
export default function useEditor(data) {
        ...
        function data_reducer(state, action) {
                ...
                var suppress_from = function suppress_from(list_, qualified_id) {
                        ...
                        var children = Global_State.getChildrenById(qualified_id);
                ...
                var isExisting = function isExisting(node_name, destination_id) {
                        var children = Global_State.getChildrenById(destination_id);
                        ...
                        try {
                                for (var _iterator3 = children[Symbol.iterator](), _step3; !(_iteratorNormalCompletion3 = (_step3 = _iterator3.next()).done); _iteratorNormalCompletion3 = true) {
                                        ...
                                        if (child.name === node_name) return true;
                                }
                        } catch (err) {
                ...
                var getNewName = function getNewName(original_name, destination_id) {
                        ...
                        case 'update_initData':
                                {
                                        ...
                                        try {
                                                for (var _iterator4 = state[Symbol.iterator](), _step4; !(_iteratorNormalCompletion4 = (_step4 = _iterator4.next()).done); _iteratorNormalCompletion4 = true) {
                                                        ...
                                                        try {
                                                                for (var _iterator5 = new_data[Symbol.iterator](), _step5; !(_iteratorNormalCompletion5 = (_step5 = _iterator5.next()).done); _iteratorNormalCompletion5 = true) {
                        ...
                        case 'move_folder':
                                {
                                        ...
                                        var destination = Global_State.getNodeDataById("" + (Global_State.parseModelToFrontType(_data2.destination_type) === 'root' ? '0' : "" + Global_State.parseModelToFrontType(_data2.destination_type) + _data2.destination_id));
                                                ...
                                                if (node.id === "ds" + _data2.id) {
                                                        ...
                                                        if (isExisting(node.name, destination.id)) {
                                                                ...
                                                                switch (parseInt(_data2.on_exist)) {
                                                                        ...
                                                                        case 3:
                                                                                {
                                                                                        var children = Global_State.getChildrenById(destination.id);
                        ...
                        case 'add_audit':
                                {
                                        ...
                                        try {
                                                for (var _iterator8 = action.jobs[Symbol.iterator](), _step8; !(_iteratorNormalCompletion8 = (_step8 = _iterator8.next()).done); _iteratorNormalCompletion8 = true) {
                                                        ...
                                                        var new_node = Global_State.createNodeData("" + type + job.node_id, "folder", getService(_data4.services), false, _data4.name, type, false, type === 'audit' ? '0' : "audit" + job.data.audit_id, "", true, undefined, type === 'audit' ? Global_State.authUser : undefined, undefined, undefined, 'pas encore créé', undefined, parseInt(_data4.section_id), undefined, undefined);
                        ...
                        case 'add_fncs':
                                {
                                        ...
                                        var audit = Global_State.getNodeDataById(Global_State.getNodeDataById("nonC" + _data5.nonC_id).parentId);

                                        for (var i = debut; i < fin + 1; i++) {
                                                var new_fnc = Global_State.createNodeData("fnc" + id.current, "folder", getService(_data5.services), false, "FNC-" + audit.name + "-" + i, "fnc", false, "nonC" + _data5.nonC_id, "", true, undefined, undefined, false, null, 'pas encore créé', _data5.level, parseInt(audit.section_id), undefined, undefined);
                                                new_fnc['onEdit'] = true;
        ...
        function jobs_reducer(state, action) {
                ...
                var getJobByNodeId = function getJobByNodeId(node_id, node_model) {
                        ...
                        try {
                                for (var _iterator12 = state[Symbol.iterator](), _step12; !(_iteratorNormalCompletion12 = (_step12 = _iterator12.next()).done); _iteratorNormalCompletion12 = true) {
                                        ...
                                        if (job.node_id === parseInt(node_id) && job.node_model === node_model) return Object.assign({}, job);
                                }
                        } catch (err) {
                                        ...
                                        var supress_from_jobs = function supress_from_jobs(job_list, id) {
                                                ...
                                                try {
                                                        for (var _iterator13 = new_job_list[Symbol.iterator](), _step13; !(_iteratorNormalCompletion13 = (_step13 = _iterator13.next()).done); _iteratorNormalCompletion13 = true) {
                                                                ...
                                                                if (Array.isArray(_job2.dependencies) && getJobByKey(_job2.dependencies[0]).node_id === id || _job2.data !== undefined && "" + _job2.data.front_parent_type + _job2.data.parent_id === "ds" + id) {
                        ...
                        case 'move_folder':
                                {
                                        ...
                                        if (parseInt(json_request.id) > 0) {
                                                var existant_job = getJobByNodeId(json_request.id, 'App\\Models\\DossierSimple');
                                                        ...
                                                        _new_state2 = _new_state2.map(function (job) {
                                                                if (job.operation === 'move') {
                                                                        if (job.node_model === 'App\\Models\\DossierSimple' && job.node_id === parseInt(json_request.id)) {
                                                                                return Object.assign({}, job, { data: json_request });
                                                                        }
                                                                        return job;
                                                                } else return job;
                                                        });
                                                ...
                                                _new_state2 = _new_state2.map(function (job) {
                                                        if (job.operation === 'add') {
                                                                if (job.node_model === 'App\\Models\\DossierSimple' && job.node_id === parseInt(json_request.id)) {
                                                                        var destination = Global_State.getNodeDataById(Global_State.parseModelToFrontType(json_request.destination_type) + json_request.destination_id);
                                                                        console.log('destination', destination);

                                                                        var services = destination.services.map(function (service) {
                                                                                return { vale: service.id, name: service.name };
                                                                        });
                                                                        var new_data = {
                        ...
                        case 'add_files':
                                {
                                        ...
                                        var _node = form_to_json(_request2);
                        ...
                        case 'del_file':
                                {
                                        ...
                                        _new_state4 = _new_state4.filter(function (job) {
                                                // console.log('del filterrrrrrrrrrrrrrrrrrrrrrrrrrrrr', job.id)
                        ...
                        case 'add_audit':
                                {
                                        ...
                                        var _node2 = form_to_json(_request3);
                                        ...
                                        var checkList_job = {
                                                ...
                                                data: {
                                                        name: 'checkList',
                                                        audit_id: _job7.node_id,
                                                        sub_type: 'checkList',
                                                        services: _job7.data.services,
                                                        section_id: _job7.data.section_id
                                                },
                                                dependencies: [_job7.id],
                                                etat: 'waiting'
                                        };
                                        job_id.current = job_id.current + 1;
                                        id.current = id.current - 1;
                                        ...
                                        _new_state5.push(_job7, checkList_job, dp_job, NC_job);

                                        setDatasState({ type: 'add_audit', jobs: [_job7, checkList_job, dp_job, NC_job] });
                        ...
                        case 'del_audit':
                                {
                                        ...
                                        var _supress_from_jobs = function _supress_from_jobs(job_list, id) {
                                                ...
                                                try {
                                                        for (var _iterator14 = new_job_list[Symbol.iterator](), _step14; !(_iteratorNormalCompletion14 = (_step14 = _iterator14.next()).done); _iteratorNormalCompletion14 = true) {
                                                                var _job8 = _step14.value;

                                                                // console.log(job, job.dependencies[0], id)
                                                                if (Array.isArray(_job8.dependencies) && getJobByKey(_job8.dependencies[0]).node_id === id || _job8.data !== undefined && "" + _job8.data.front_parent_type + _job8.data.parent_id === "audit" + id) {
                                                                        // console.log(job, job.dependencies[0], getJobByKey(job.dependencies[0]), id)
                                                                        new_job_list = _supress_from_jobs(new_job_list, _job8.node_id);
                                                                }
                                                        }
                                                } catch (err) {
                                        ...
                                        var _new_state6 = _supress_from_jobs([].concat(_toConsumableArray(state)), _id3);
                        ...
                        case 'add_fncs':
                                {
                                        ...
                                        var _node3 = form_to_json(_request4);
                                        var _job10 = {
                                                id: job_id.current,
                                                operation: 'add',
                                                // node_id: id.current,
                                        ...
                                        _new_state7.push(_job10);

                                        job_id.current = job_id.current + 1;

                                        setDatasState({ type: 'add_fncs', job: _job10 });
                        ...
                        case 'del_fnc':
                                {
                                        ...
                                        var _supress_from_jobs2 = function _supress_from_jobs2(job_list, id) {
                                                ...
                                                try {
                                                        for (var _iterator15 = new_job_list[Symbol.iterator](), _step15; !(_iteratorNormalCompletion15 = (_step15 = _iterator15.next()).done); _iteratorNormalCompletion15 = true) {
                                                                var _job11 = _step15.value;

                                                                // console.log(job, job.dependencies[0], id)
                                                                if (Array.isArray(_job11.dependencies) && getJobByKey(_job11.dependencies[0]).node_id === id || _job11.data !== undefined && "" + _job11.data.front_parent_type + _job11.data.parent_id === "fnc" + id) {
                                                                        // console.log(job, job.dependencies[0], getJobByKey(job.dependencies[0]), id)
                                                                        new_job_list = _supress_from_jobs2(new_job_list, _job11.node_id);
                                                                }
                                                        }
                                                } catch (err) {
                                        ...
                                        var _new_state8 = _supress_from_jobs2([].concat(_toConsumableArray(state)), _id4);
                                        ...
                                        if (!(parseInt(_id4) < 0)) {
                                                ...
                                                _new_state8 = _new_state8.map(function (job) {
                        ...
                        case 'update_fnc':
                                {
                                        ...
                                        var _node4 = form_to_json(_request5);
                                        ...
                                        try {
                                                for (var _iterator16 = _new_state9[Symbol.iterator](), _step16; !(_iteratorNormalCompletion16 = (_step16 = _iterator16.next()).done); _iteratorNormalCompletion16 = true) {
                                                        var _job14 = _step16.value;
